...
1. Do not commit `apps/ios/Config/Local.xcconfig` or `apps/macos/AvtunesysMac/Config/Local.xcconfig`.
...
The command resolves through the private AV Account Varlock/Infisical bootstrap. This public repository should not contain `.env.example`, `.infisical/bootstrap.env.example`, or generated local config examples.
