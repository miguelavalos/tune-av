...
struct ProfileView: View {
    ...
    private var accessCard: some View {
        SettingsCard(title: "Access", subtitle: "Matches the AV Tunesys product model across iOS and macOS.") {
    ...
    private var aboutCard: some View {
        SettingsCard(title: "About", subtitle: "Independent macOS edition.") {
            ...
            SettingsStatsRow(title: "Design", value: "Desktop UX aligned with AV Tunesys iOS")
