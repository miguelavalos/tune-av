...
struct StationArtworkView: View {
    ...
    private var backgroundGradient: LinearGradient {
        ...
        case .dark:
            return LinearGradient(
                colors: [TuneAVTheme.darkSurface, TuneAVTheme.darkSurface.opacity(0.92)],
                startPoint: .topLeading,
                endPoint: .bottomTrailing
            )
        }
    ...
    private var borderColor: Color {
        switch surfaceStyle {
        case .light: return TuneAVTheme.borderSubtle
    ...
    private var shadowColor: Color {
        switch surfaceStyle {
        case .light: return TuneAVTheme.softShadow.opacity(0.08)
        case .dark: return TuneAVTheme.softShadow.opacity(0.18)
        }
    }

    private var fallbackTextColor: Color {
        switch surfaceStyle {
        case .light: return TuneAVTheme.textPrimary.opacity(0.92)
        case .dark: return TuneAVTheme.textInverse.opacity(0.9)
        }
    }
}
