...
enum TuneAVTheme {
    ...
    static let textPrimary = dynamicColor(
        light: NSColor(red: 58 / 255, green: 58 / 255, blue: 54 / 255, alpha: 1),
    ...
    static let shellBackground = LinearGradient(
        colors: [
            dynamicColor(
                light: NSColor.white,
                dark: NSColor(red: 20 / 255, green: 22 / 255, blue: 20 / 255, alpha: 1)
            ),
            dynamicColor(
                light: NSColor(red: 247 / 255, green: 249 / 255, blue: 248 / 255, alpha: 1),
                dark: NSColor(red: 32 / 255, green: 35 / 255, blue: 32 / 255, alpha: 1)
            ),
            dynamicColor(
                light: NSColor(red: 238 / 255, green: 242 / 255, blue: 239 / 255, alpha: 1),
                dark: NSColor(red: 42 / 255, green: 46 / 255, blue: 42 / 255, alpha: 1)
            )
        ],
