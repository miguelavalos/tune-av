...
const en = {
  ...
  tune: {
    ...
    externalSearchDetail: "Choose where Tune AV searches public info and lyrics.",
...
export const tuneProfileLabels: Record<AppsAvLocale, typeof en> = {
  ...
  es: {
    ...
    account: { ...en.account, connected: "Conectado a Account AV.", emailTitle: "Correo", planFree: "Tune AV Free", planPro: "Tune AV Pro", planTitle: "Tipo de cuenta", sessionTitle: "Sesion", signOut: "Cerrar sesion", signedIn: "Sesion iniciada", title: "Cuenta" },
  ...
  ca: {
    ...
    account: { ...en.account, connected: "Connectat a Account AV.", emailTitle: "Correu electronic", planFree: "Tune AV Free", planPro: "Tune AV Pro", planTitle: "Pla", sessionTitle: "Sessio", signOut: "Tancar sessio", signedIn: "Sessio iniciada", title: "Compte" },
    ...
    tune: { ...en.tune, countryDetail: "El pais preferit s'usa com a feed inicial quan esta disponible.", countryTitle: "Pais d'emissores", discoveryDetail: "Musica prioritza emissores amb metadata de pistes; tota la radio mante el feed mes ampli.", discoveryOptions: { allRadio: "Tota la radio", music: "Musica" }, discoveryTitle: "Mode de descobriment", externalSearchDetail: "Tria on cerca Tune AV informacio publica i lletres.", externalSearchTitle: "Motor de cerca", genreDetail: "El genere preferit s'usa com a punt de partida.", genreTitle: "Genere preferit", subtitle: "Tune AV mante aquestes preferencies locals en aquest navegador.", title: "Preferencies d'escolta" },
  ...
  de: {
    ...
    account: { ...en.account, connected: "Verbunden mit Account AV.", emailTitle: "E-Mail", planFree: "Tune AV Free", planPro: "Tune AV Pro", planTitle: "Tarif", sessionTitle: "Sitzung", signOut: "Abmelden", signedIn: "Angemeldet", title: "Konto" },
    ...
    tune: { ...en.tune, countryDetail: "Das bevorzugte Land wird als Startfeed genutzt, wenn verfuegbar.", countryTitle: "Senderland", discoveryDetail: "Musik priorisiert Sender mit Track-Metadaten; alle Radios halten den Feed breiter.", discoveryOptions: { allRadio: "Alle Radios", music: "Musik" }, discoveryTitle: "Entdeckungsmodus", externalSearchDetail: "Waehle, wo Tune AV oeffentliche Infos und Songtexte sucht.", externalSearchTitle: "Suchmaschine", genreDetail: "Das bevorzugte Genre wird als Startpunkt genutzt.", genreTitle: "Bevorzugtes Genre", subtitle: "Tune AV haelt diese Einstellungen lokal in diesem Browser.", title: "Hoer-Einstellungen" },
  ...
  fr: {
    ...
    account: { ...en.account, connected: "Connecte a Account AV.", emailTitle: "E-mail", planFree: "Tune AV Free", planPro: "Tune AV Pro", planTitle: "Formule", sessionTitle: "Session active", signOut: "Se deconnecter", signedIn: "Connecte", title: "Compte" },
    ...
    tune: { ...en.tune, countryDetail: "Le pays prefere sert de flux initial quand il est disponible.", countryTitle: "Pays des stations", discoveryDetail: "Musique priorise les stations avec metadonnees de titres; toute la radio garde un flux plus large.", discoveryOptions: { allRadio: "Toute la radio", music: "Musique" }, discoveryTitle: "Mode de decouverte", externalSearchDetail: "Choisissez ou Tune AV cherche les infos publiques et paroles.", externalSearchTitle: "Moteur de recherche", genreDetail: "Le genre prefere sert de point de depart.", genreTitle: "Genre prefere", subtitle: "Tune AV garde ces preferences localement dans ce navigateur.", title: "Preferences d'ecoute" },
