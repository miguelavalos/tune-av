...
struct ProfileScreen: View {
    ...
    private var profileSummaryCard: some View {
        VStack(alignment: .leading, spacing: 20) {
            ...
            Divider()
                .overlay(AvtunesysTheme.borderSubtle)
...
private struct ProfileAvatar: View {
    ...
    var body: some View {
        ZStack {
            Circle()
                .fill(AvtunesysTheme.highlight.opacity(0.14))
        ...
        .overlay {
            Circle()
                .stroke(AvtunesysTheme.highlight.opacity(0.16), lineWidth: 1)
        }
    }
}
    ...
    var body: some View {
        Button(action: action) {
            HStack(spacing: 12) {
                ...
                if isLoading {
                    ProgressView()
                        .tint(AvtunesysTheme.textPrimary)
                }
            }
            .foregroundStyle(AvtunesysTheme.textPrimary)
            .frame(maxWidth: .infinity)
        ...
        Button(action: action) {
            HStack(alignment: .top, spacing: 12) {
                ...
                Image(systemName: "chevron.right")
                    ...
                    .foregroundStyle(AvtunesysTheme.textSecondary.opacity(0.7))
                    .padding(.top, 4)
            }
            .padding(16)
            .background(
...
private struct ThemeOptionButton: View {
    ...
    var body: some View {
        Button(action: action) {
            ...
            .background(
                RoundedRectangle(cornerRadius: 18, style: .continuous)
                    .fill(isSelected ? AvtunesysTheme.highlight.opacity(0.1) : AvtunesysTheme.mutedSurface)
            )
            .overlay {
                RoundedRectangle(cornerRadius: 18, style: .continuous)
                    .stroke(isSelected ? AvtunesysTheme.highlight.opacity(0.35) : AvtunesysTheme.borderSubtle, lineWidth: 1)
            }
        }
        .buttonStyle(.plain)
    }
