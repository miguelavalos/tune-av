...
struct RootView: View {
    ...
    private func refreshLibrarySync() async {
        ...
        let appDataService = AVTunesysAppDataService(
        ...
        VStack(alignment: .leading, spacing: 22) {
            HStack(spacing: 14) {
                Image(systemName: "sparkles")
                    ...
                    .background(AvtunesysTheme.highlight, in: RoundedRectangle(cornerRadius: 16, style: .continuous))
            ...
            VStack(spacing: 12) {
                ...
                Button(action: onDismiss) {
                    Text(L10n.string("limits.upgrade.notNow"))
                        ...
                        .frame(maxWidth: .infinity)
                        .padding(.vertical, 14)
                        .background(AvtunesysTheme.mutedSurface, in: RoundedRectangle(cornerRadius: 16, style: .continuous))
                }
        ...
        ZStack {
            ...
            VStack(spacing: 18) {
                Image("BrandMark")
                    ...
                    .padding(14)
                    .background(AvtunesysTheme.cardSurface, in: RoundedRectangle(cornerRadius: 18, style: .continuous))
                    .overlay {
