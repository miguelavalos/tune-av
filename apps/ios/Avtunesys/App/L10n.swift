...
final class AppLanguageController: ObservableObject {
    ...
    private let userDefaultsKey = "avtunesys.appLanguage"
...
enum L10n {
    static var locale: Locale {
        AppLanguage.resolved(from: UserDefaults.standard.string(forKey: "avtunesys.appLanguage")).locale
    }
    ...
    private static var bundle: Bundle {
        let selectedLanguage = AppLanguage.resolved(from: UserDefaults.standard.string(forKey: "avtunesys.appLanguage"))
