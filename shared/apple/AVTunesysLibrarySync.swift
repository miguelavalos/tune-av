...
struct AVTunesysLibraryDocument {
...
enum AVTunesysLibrarySyncDecision: Equatable {
    case pullRemote(AVTunesysLibrarySnapshot)
    case pushLocal
    case noContent
    case alreadyCurrent
}

enum AVTunesysLibrarySyncPlanner {
    static func decision(
        localSnapshot: AVTunesysLibrarySnapshot,
        localUpdatedAt: Date,
        remoteDocument: AVTunesysLibraryDocument
    ) -> AVTunesysLibrarySyncDecision {
...
enum AVTunesysLibrarySnapshotMerger {
    static func merged(local: AVTunesysLibrarySnapshot, remote: AVTunesysLibrarySnapshot) -> AVTunesysLibrarySnapshot {
...
enum AVTunesysAppDataError: Error {
    case conflict
}

struct AVTunesysLibrarySnapshot: Codable, Equatable {
