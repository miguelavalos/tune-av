...
This folder is reserved for platform-neutral Tune AV contracts.
...
- `access-policy.json`: canonical Tune AV access modes, plan tiers, capabilities, and per-mode limits. iOS validates its `AccessLimits` and `AccessCapabilities` Adapter against this file.
