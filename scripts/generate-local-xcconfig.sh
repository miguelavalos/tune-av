...
delete_account_url="$(printenv_first_value TUNEAV_DELETE_ACCOUNT_URL ACCOUNTAV_DELETE_ACCOUNT_URL)"
...
TUNEAV_DELETE_ACCOUNT_URL = $(xcodebuild_url_value "${delete_account_url:-}")
