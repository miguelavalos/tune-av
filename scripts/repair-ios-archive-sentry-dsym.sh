...
usage() {
  cat <<'USAGE'
Usage:
  scripts/repair-ios-archive-sentry-dsym.sh --archive <TuneAV.xcarchive>

Generates the dSYM for Xcode's Sentry.framework stub inside a Tune AV iOS
...
sentry_binary="$archive_path/Products/Applications/TuneAV.app/Frameworks/Sentry.framework/Sentry"
